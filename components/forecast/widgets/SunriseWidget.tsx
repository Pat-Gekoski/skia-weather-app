...
import { Canvas, Circle, Line, LinearGradient, Paint, Path, Skia, vec } from '@shopify/react-native-skia'
	...
	return (
		<>
			<Widget width={width} height={height}>
				<Widget.Header Icon={Feather} iconProps={{ name: 'sunrise' }} contentText='sunrise' />
					...
					<Canvas style={{ flex: 1 }}>
						<Path path={cosWave()} style={'stroke'} strokeWidth={5}>
							<LinearGradient
								...
								colors={['#102756', '#102756', '#8CA4CC', '#8CA4CC', '#102756', '#102756']}
							/>
						</Path>

						<Line color={'white'} p1={vec(0, 40)} p2={vec(width - 20, 40)} strokeWidth={1} />
					</Canvas>
					<Canvas
						style={{
