...
Widget.Body = ({ children, contentText, contentSize = 'Normal', subContentText }: WidgetBodyProps) => {
	return (
		<View style={{ flex: 1 }}>
			{contentText && <Text style={contentSize === 'Normal' ? styles.contentText : styles.largeContentText}>{contentText}</Text>}
